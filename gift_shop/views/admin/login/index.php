                        ...
                        <div class="card card-plain mt-8">
                            ...
                            <?php endif; ?>
                                <form action="/admin/login/submit" method="POST">
                                    <label>Email</label>
                                    <div class="mb-3">
                                        <input type="text" name="username" class="form-control" placeholder="Email" aria-label="Email" aria-describedby="email-addon" required>
                                    </div>
...
<script src="/public/js/soft-ui-dashboard.min.js?v=1.1.0"></script>
</body>
