...
<head>
  ...
  <!-- CSS Files -->
  <link id="pagestyle" href="/public/css/soft-ui-dashboard.css?v=1.1.0" rel="stylesheet" />
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="" >
        <img src="/public/images/logo/logo_black.png" class="navbar-brand-img h-100" alt="main_logo">
        <br>
    ...
    <div >
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link <?= $dashboard_active ?? null ?> " href="/admin/dashboard">
        ...
        <li class="nav-item">
          <a class="nav-link <?= $user_active ?? null ?>" href="/admin/users">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link <?= $category_active ?? null ?> " href="/admin/category">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link  <?= $review_active ?? null ?>" href="/admin/reviews">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <li class="nav-item">
          <a class="nav-link <?= $coupon_active ?? null ?> " href="/admin/coupons">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link <?= $order_active ?? null ?> " href="/admin/orders">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>settings</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
